#!/usr/bin/env python3
"""Run the sequential dual-ETF parameter sweep with Longbridge market data."""
...
def main():
    parser = argparse.ArgumentParser(description="Longbridge-backed dual ETF parameter sweep")
